...
namespace DUCK.Tween
{
	...
	public abstract class AbstractAnimation
	{
		...
		protected Func<bool> onUpdateWhileCallback;
		...
		public virtual void PlayWhile(Action onComplete, Func<bool> updateWhile, Action onAbort = null)
		{
			if (!IsValid)
			{
				Debug.LogError("Cannot play animation: Invalid!");
			...
			onCompleteCallback = onComplete;
			onAbortCallback = onAbort;
			onUpdateWhileCallback = updateWhile;
